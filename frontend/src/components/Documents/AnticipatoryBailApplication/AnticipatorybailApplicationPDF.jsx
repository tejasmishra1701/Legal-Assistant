...
export const AnticipatorybailApplicationPDF = ({ data }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.partyContainer}>
        <View>
          ...
          <Text>Aged: {data.parties.applicant.age} years</Text>
          <Text>Occupation: {data.parties.applicant.occupation}</Text>
        </View>
      ...
      <View style={styles.section}>
        <Text>FIR NO. {data.parties.caseInfo.firNumber}/{data.parties.caseInfo.firYear}</Text>
        <Text>U/S. {data.parties.caseInfo.sections}</Text>
        <Text>POLICE STATION: {data.parties.caseInfo.policeStation}</Text>
        <Text>DATE OF FIR: {data.parties.caseInfo.dateOfComplaint}</Text>
      </View>
